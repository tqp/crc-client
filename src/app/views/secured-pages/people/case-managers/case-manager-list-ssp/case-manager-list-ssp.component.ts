...
@Component({
  selector: 'app-case-manager-list-ssp',
  templateUrl: './case-manager-list-ssp.component.html',
  styleUrls: ['./case-manager-list-ssp.component.css']
})
export class CaseManagerListSspComponent implements OnInit, OnDestroy {
