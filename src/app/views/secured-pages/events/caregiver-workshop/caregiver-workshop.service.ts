...
export class CaregiverWorkshopService {
  ...
  public createCaregiverWorkshop(workshop: CaregiverWorkshop): Observable<Relationship> {
  ...
  public getCaregiverWorkshopListByCaregiverId(caregiverId: number): Observable<CaregiverWorkshop[]> {
