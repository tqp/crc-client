...
@Component({
  ...
  templateUrl: './student-list-by-case-manager.component.html',
  styleUrls: ['./student-list-by-case-manager.component.css']
})
export class StudentListByCaseManagerComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.getStudentListByCaseManager();
  }
  ...
  public getStudentListByCaseManager(): void {
    this.isLoading = true;
    this.eventService.loadingEvent.emit(true);
    this.studentService.getStudentListByCaseManager().subscribe(
      (response: any | null) => {
