...
@Component({
  selector: 'app-sponsor-list-ssp',
  templateUrl: './sponsor-list-ssp.component.html',
  styleUrls: ['./sponsor-list-ssp.component.css']
})
export class SponsorListSspComponent implements OnInit, OnDestroy {
